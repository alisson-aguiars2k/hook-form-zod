...
export function App() {
  ...
  return (
    <main className="h-screen flex  flex-col gap-6 items-center justify-center bg-indigo-900 bg-gradient-to-r from-neutral-950">
      <h1 className="font-sans text-transparent text-8xl bg-clip-text bg-gradient-to-r from-yellow-800 to-yellow-900">
        Hook Form + Zod
      </h1>
      <FormProvider {...createUserForm}>
        ...
        >
          ...
          <button
            ...
            className="bg-indigo-300 text-white rounded px-3 h-10 font-semibold text-sm hover:bg-yellow-900"
          >
            Salvar
          </button>
        </form>
